...
ACCOUNTS = {
    ...
    "micro_donchian_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "micro_donchian"},
    "bollinger_pinch_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "bollinger_pinch"},
    "macd_pulse_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "macd_pulse"},
    "atr_flicker_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "atr_flicker"},
    "volume_pulse_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "volume_pulse"},
    "tick_momentum_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "tick_momentum"},
    ...
    "rsi_scalp_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "rsi_scalp"},
    "ema_scalp_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "ema_scalp"},
    "momentum_scalp_500": {"label": "500 USDT", "starting_cash": 500.0, "strategy": "momentum_scalp"},
    ...
    "pendel_bot_500": {"label": "500 USDC", "starting_cash": 500.0, "strategy": "pendel_bot"},
    "herzschlag_bot_500": {"label": "500 USDC", "starting_cash": 500.0, "strategy": "herzschlag_bot"},
    "wackelkontakt_bot_500": {"label": "500 USDC", "starting_cash": 500.0, "strategy": "wackelkontakt_bot"},
    "sekundenschlaf_bot_500": {"label": "500 USDC", "starting_cash": 500.0, "strategy": "sekundenschlaf_bot"},
    "trommelwirbel_bot_500": {"label": "500 USDC", "starting_cash": 500.0, "strategy": "trommelwirbel_bot"},
}

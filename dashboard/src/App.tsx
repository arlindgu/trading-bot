...
type Category = "real" | "joke"
type Frequency = "normal" | "high"
const STRATEGIES: { id: StrategyId; label: string; description: string; category: Category; frequency: Frequency }[] = [
...
const GROUPS: { key: Category; frequency: Frequency; label: string }[] = [
